...
const Expertise = () => {
  ...
  return (
    <motion.div
      ...
      className="relative md:top-[25px] s:top-[100px] xxxs:top-[90px] h-fit rounded-2xl flex md:justify-center s:justify-center xxxs:justify-between xxxs:pb-5"
    >
      ...
      "
        ...
        {/* divide */}
        <div className="items-center flex flex-col xxxs:p-2 xxxs:mr-[13px] relative">
          <motion.div
          ...
          <motion.svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="xxxs:w-4 md:h-[40px] md:w-[40px]  s:h-[30px] s:w-[30px]  relative md:right-[15px] s:right-[14px] xxxs:right-[7px] xxxs:top-[25.5rem] md:top-[28rem] s:top-[40rem] text-green-500"
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
          ...
          <motion.svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="xxxs:w-4 md:h-[40px] md:w-[40px] s:h-[30px] s:w-[30px] relative md:right-[15px] s:right-[14px] xxxs:right-[7px] md:top-[12rem] xxxs:top-[10.5rem] s:top-[15rem] text-pink-500"
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
          ...
          <motion.svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="xxxs:w-4 xxxs:h-4 md:h-[40px] s:h-[40px] s:w-[30px] md:w-[40px] relative  md:top-[24rem] xxxs:top-[22.2rem] s:top-[34rem] text-pink-500 md:left-[15px] xxxs:left-[4px]  s:left-[14px]"
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
          ...
          <motion.svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="xxxs:w-4 md:h-[40px] md:w-[40px] s:h-[40px] s:w-[30px] relative  md:top-[8.5vh] s:top-[1vh] xxxs:top-[2rem] text-green-500 md:left-[15px] xxxs:left-[4px]  s:left-[14px]"
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
